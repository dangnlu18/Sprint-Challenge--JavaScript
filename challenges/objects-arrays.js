...
const univs = graduates.map((line) => line.university)
const universities = univs.sort();
...
const contactInfo = graduates.map((line) => `${line.first_name}  ${line.email}`);
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = univs.filter(item => item.includes('Uni'));
